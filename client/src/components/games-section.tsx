    ...
    <section id="games" className="py-20 florida-gradient">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Scavenger Hunt */}
          <div ref={scavengerRef} className="scroll-fade" data-testid="card-scavenger-hunt">
            <div className="bg-card rounded-2xl p-8 shadow-lg">
              ...
              <ul className="space-y-3 text-muted-foreground">
                ...
                <li className="flex items-center" data-testid="feature-scavenger-leaderboards">
                  <CheckCircle className="text-accent mr-3 w-5 h-5" />
          ...
          >
            <div className="bg-card rounded-2xl p-8 shadow-lg">
              ...
              <ul className="space-y-3 text-muted-foreground">
                ...
                <li className="flex items-center" data-testid="feature-poker-collection">
                  <CheckCircle className="text-accent mr-3 w-5 h-5" />
