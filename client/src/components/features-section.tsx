    ...
    <section id="features" className="py-20 bg-muted">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={sectionRef} className="text-center mb-16 scroll-fade">
          ...
          >
            Designed specifically for golf carts and low-speed vehicles, Cartin'
            provides accurate navigation tailored to everyday streets and
            communities.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3
              ...
              data-testid="text-feature-gps-title"
            >
              GPS Navigation
            </h3>
            <p
              className="text-muted-foreground leading-relaxed"
              data-testid="text-feature-gps-description"
            >
              Precise GPS navigation optimized for legal low speed vehicle
              routes. Explore your area or a new one like never before.
            </p>
          </div>
          ...
          >
            ...
            <h3
              className="text-2xl font-bold text-card-foreground mb-4"
              data-testid="text-feature-course-title"
            >
              Game Integration
            </h3>
            <p
              className="text-muted-foreground leading-relaxed"
              data-testid="text-feature-course-description"
            >
              Seamlessly integrates games into navigation experience, providing
              an easy-to-use and fun experience.
            </p>
          </div>
          ...
          >
            ...
            <h3
              className="text-2xl font-bold text-card-foreground mb-4"
              data-testid="text-feature-updates-title"
            >
              Real-time Updates
            </h3>
            <p
              className="text-muted-foreground leading-relaxed"
              data-testid="text-feature-updates-description"
            >
              Get real-time updates on weather and optimal routes for your golf
              cart journey.
            </p>
          </div>
        </div>
